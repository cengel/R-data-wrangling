...
(If you need to, you can also download the data from here: https://github.com/cengel/R-data-wrangling/raw/master/data_output/MS_county_stops.csv)
...
```{r, count-weekly-violations, purl=FALSE}
trafficstops %>%
