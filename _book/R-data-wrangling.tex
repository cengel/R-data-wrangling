...
\setlength{\droptitle}{-2em}
  ...
  \postdate{\par}
  \date{Last updated: February 08, 2018}
...
\CommentTok{# Answer2     }
\NormalTok{trafficstops }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(driver_age }\OperatorTok{>=}\StringTok{ }\DecValTok{16}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{wk_day =} \KeywordTok{wday}\NormalTok{(stop_date, }\DataTypeTok{label =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}\StringTok{  }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(wk_day, driver_race, violation) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{avg_age =} \KeywordTok{mean}\NormalTok{(driver_age)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ wk_day, }\DataTypeTok{y =}\NormalTok{ avg_age, }\DataTypeTok{group =}\NormalTok{ driver_race, }\DataTypeTok{color =}\NormalTok{ driver_race)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}
...
\includegraphics{R-data-wrangling_files/figure-latex/average-age-time-series-2.pdf}
--\textgreater{}
