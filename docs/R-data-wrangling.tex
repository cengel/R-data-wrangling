...
\setlength{\droptitle}{-2em}
  ...
  \postdate{\par}
  \date{Last updated: October 05, 2017}
...
\item
  ...
  \texttt{data}.
\item
  Optional: Download the Code Handout from here\ldots{}
\end{itemize}

\textbf{Next workshop:\\
Thu, November 16, 2017, 1:30-4pm,\\
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(trafficstops[trafficstops$county_name ==}\StringTok{ "Tallahatchie County"}\NormalTok{, }\StringTok{"driver_age"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(trafficstops[trafficstops$county_name ==}\StringTok{ "Walthall County"}\NormalTok{, }\StringTok{"driver_age"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(trafficstops[trafficstops$county_name ==}\StringTok{ "Oktibbeha County"}\NormalTok{, }\StringTok{"driver_age"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{filter}\NormalTok{(trafficstops, county_name ==}\StringTok{ "Tallahatchie County"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tmp_df <-}\StringTok{ }\KeywordTok{filter}\NormalTok{(trafficstops, driver_age >}\StringTok{ }\DecValTok{85}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{select}\NormalTok{(}\KeywordTok{filter}\NormalTok{(trafficstops, driver_age >}\StringTok{ }\DecValTok{85}\NormalTok{), violation_raw, driver_gender, driver_race)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{trafficstops %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(driver_age >}\StringTok{ }\DecValTok{85}\NormalTok{) %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{senior_drivers <-}\StringTok{ }\NormalTok{trafficstops %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(driver_age >}\StringTok{ }\DecValTok{85}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(violation_raw, driver_gender, driver_race)}
...
\NormalTok{trafficstops %>%}\StringTok{ }
...
\begin{Highlighting}[]
\NormalTok{trafficstops %>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{birth_year =} \KeywordTok{year}\NormalTok{(}\KeywordTok{ymd}\NormalTok{(driver_birthdate))) %>%}\StringTok{ }
...
\NormalTok{trafficstops %>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{birth_year =} \KeywordTok{year}\NormalTok{(}\KeywordTok{ymd}\NormalTok{(driver_birthdate)),}
           \DataTypeTok{birth_cohort =} \KeywordTok{round}\NormalTok{(birth_year/}\DecValTok{10}\NormalTok{)*}\DecValTok{10}\NormalTok{) %>%}\StringTok{ }
\StringTok{    }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{trafficstops %>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{birth_year =} \KeywordTok{year}\NormalTok{(}\KeywordTok{ymd}\NormalTok{(driver_birthdate)),}
           \DataTypeTok{birth_cohort =} \KeywordTok{round}\NormalTok{(birth_year/}\DecValTok{10}\NormalTok{)*}\DecValTok{10}\NormalTok{,}
           \DataTypeTok{birth_cohort =} \KeywordTok{factor}\NormalTok{(birth_cohort)) %>%}
\StringTok{    }\KeywordTok{select}\NormalTok{(birth_cohort) %>%}\StringTok{ }
...
\begin{Highlighting}[]
\NormalTok{trafficstops %>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(driver_race) %>%}
...
\begin{Highlighting}[]
\NormalTok{trafficstops %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(!}\KeywordTok{is.na}\NormalTok{(driver_race)) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(driver_race) %>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_age =} \KeywordTok{mean}\NormalTok{(driver_age, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{trafficstops %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(!}\KeywordTok{is.na}\NormalTok{(driver_race)) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(driver_race, driver_gender) %>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_age =} \KeywordTok{mean}\NormalTok{(driver_age, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
Add in \texttt{count} and \texttt{n()}
...
\begin{Highlighting}[]
\NormalTok{trafficstops %>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(officer_id) %>%}
...
\begin{Highlighting}[]
\NormalTok{trafficstops %>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(MS_bw_pop, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"county_fips"} \NormalTok{=}\StringTok{ "FIPS"}\NormalTok{)) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{trafficstops_ma <-}\StringTok{ }\NormalTok{trafficstops %>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(!}\KeywordTok{is.na}\NormalTok{(driver_gender)) %>%}
\StringTok{    }\KeywordTok{group_by}\NormalTok{(county_name, driver_gender) %>%}
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_age =} \KeywordTok{mean}\NormalTok{(driver_age, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{trafficstops_ma_wide <-}\StringTok{ }\NormalTok{trafficstops_ma %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{trafficstops_ma_wide %>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{agediff =} \NormalTok{male -}\StringTok{ }\NormalTok{female) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(agediff %in%}\StringTok{ }\KeywordTok{range}\NormalTok{(agediff))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{trafficstops_ma_long <-}\StringTok{ }\NormalTok{trafficstops_ma_wide %>%}
\StringTok{  }\KeywordTok{gather}\NormalTok{(gender, mean_age, -county_name)}
...
\StringTok{  }\KeywordTok{gather}\NormalTok{(gender, mean_age, female:male) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{trafficstops %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(!}\KeywordTok{is.na}\NormalTok{(driver_race)) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{count}\NormalTok{(county_name, county_fips, driver_race) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{spread}\NormalTok{(driver_race, n, }\DataTypeTok{fill =} \DecValTok{0}\NormalTok{, }\DataTypeTok{sep =} \StringTok{"_"}\NormalTok{) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# make sure you have the other table loaded}
\NormalTok{MS_bw_pop <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/MS_acs2015_bw.csv"}\NormalTok{)}
...
\StringTok{  }\KeywordTok{spread}\NormalTok{(driver_race, n, }\DataTypeTok{fill =} \DecValTok{0}\NormalTok{, }\DataTypeTok{sep =} \StringTok{"_"}\NormalTok{) %>%}\StringTok{  }
\StringTok{  }\KeywordTok{left_join}\NormalTok{(MS_bw_pop, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"county_fips"} \NormalTok{=}\StringTok{ "FIPS"}\NormalTok{)) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pct_black =} \NormalTok{driver_race_Black/black_pop,}
         \DataTypeTok{pct_white =} \NormalTok{driver_race_White/white_pop) %>%}\StringTok{ }
...
\begin{verbatim}
#> # A tibble: 82 x 8
#>     county_name county_fips driver_race_Black driver_race_White black_pop white_pop  pct_black  pct_white
...
\StringTok{  }\KeywordTok{spread}\NormalTok{(driver_race, n, }\DataTypeTok{fill =} \DecValTok{0}\NormalTok{, }\DataTypeTok{sep =} \StringTok{"_"}\NormalTok{) %>%}\StringTok{  }
\StringTok{  }\KeywordTok{left_join}\NormalTok{(MS_bw_pop, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"county_fips"} \NormalTok{=}\StringTok{ "FIPS"}\NormalTok{)) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pct_black_stopped =} \NormalTok{driver_race_Black/black_pop,}
         \DataTypeTok{pct_white_stopped =} \NormalTok{driver_race_White/white_pop) %>%}\StringTok{ }
...
\NormalTok{MS_plot +}\StringTok{ }\KeywordTok{geom_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{MS_demographic %>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{pct_black_stopped, }\DataTypeTok{y =} \NormalTok{pct_white_stopped)) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{MS_demographic %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(pct_white_stopped <}\StringTok{ }\FloatTok{0.5} \NormalTok{&}\StringTok{ }\NormalTok{pct_black_stopped <}\StringTok{ }\FloatTok{0.5}\NormalTok{) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{pct_black_stopped, }\DataTypeTok{y =} \NormalTok{pct_white_stopped)) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{pct_black_stopped, }\DataTypeTok{y =} \NormalTok{pct_white_stopped)) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.3}\NormalTok{, }\DataTypeTok{color=} \StringTok{"blue"}\NormalTok{) +}
\StringTok{  }\KeywordTok{geom_abline}\NormalTok{(}\DataTypeTok{intercept =} \DecValTok{0}\NormalTok{) +}\StringTok{ }
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{limits =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.1}\NormalTok{)) +}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(trafficstops, }\KeywordTok{aes}\NormalTok{(violation)) +}\StringTok{ }
...
\begin{Highlighting}[]
\NormalTok{MS_demographic %>%}\StringTok{   }
\StringTok{  }\KeywordTok{filter}\NormalTok{(pct_white_stopped <}\StringTok{ }\FloatTok{0.5} \NormalTok{&}\StringTok{ }\NormalTok{pct_black_stopped <}\StringTok{ }\FloatTok{0.5}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{county_name, }\DataTypeTok{y =} \NormalTok{pct_white_stopped -}\StringTok{ }\NormalTok{pct_black_stopped)) +}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Chickasaw_stops <-}\StringTok{ }\KeywordTok{filter}\NormalTok{(trafficstops, county_name ==}\StringTok{ "Chickasaw County"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =} \NormalTok{Chickasaw_stops, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{violation, }\DataTypeTok{y =} \NormalTok{driver_age)) +}
...
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =} \NormalTok{Chickasaw_stops, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{violation, }\DataTypeTok{y =} \NormalTok{driver_age)) +}
\StringTok{    }\KeywordTok{geom_jitter}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.1}\NormalTok{, }\DataTypeTok{color =} \StringTok{"tomato"}\NormalTok{) +}\StringTok{ }
\StringTok{    }\KeywordTok{geom_boxplot}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =} \NormalTok{Chickasaw_stops, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{violation, }\DataTypeTok{y =} \NormalTok{driver_age)) +}
\StringTok{    }\KeywordTok{geom_jitter}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.1}\NormalTok{, }\DataTypeTok{color =} \StringTok{"tomato"}\NormalTok{) +}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(lubridate)}
\KeywordTok{class}\NormalTok{(trafficstops$stop_date)}
\NormalTok{trafficstops$stop_date <-}\StringTok{ }\KeywordTok{ymd}\NormalTok{(trafficstops$stop_date)}
\KeywordTok{class}\NormalTok{(trafficstops$stop_date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{trafficstops %>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{wk_day =} \KeywordTok{wday}\NormalTok{(stop_date, }\DataTypeTok{label =} \OtherTok{TRUE}\NormalTok{)) %>%}\StringTok{  }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(wk_day, violation) %>%}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{wk_day =} \KeywordTok{wday}\NormalTok{(stop_date, }\DataTypeTok{label =} \OtherTok{TRUE}\NormalTok{)) %>%}\StringTok{  }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(wk_day, violation) %>%}
\StringTok{  }\NormalTok{tally %>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{wk_day, }\DataTypeTok{y =} \NormalTok{n)) +}
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(wk_day, violation) %>%}
\StringTok{  }\NormalTok{tally %>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{wk_day, }\DataTypeTok{y =} \NormalTok{n, }\DataTypeTok{group =} \NormalTok{violation)) +}
\StringTok{     }\KeywordTok{geom_line}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(wk_day, violation) %>%}
\StringTok{  }\NormalTok{tally %>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{wk_day, }\DataTypeTok{y =} \NormalTok{n, }\DataTypeTok{group =} \NormalTok{violation, }\DataTypeTok{color =} \NormalTok{violation)) +}
\StringTok{     }\KeywordTok{geom_line}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{wk_day, }\DataTypeTok{y =} \NormalTok{n, }\DataTypeTok{group =} \NormalTok{violation)) +}
\StringTok{     }\KeywordTok{geom_line}\NormalTok{() +}
\StringTok{     }\KeywordTok{facet_wrap}\NormalTok{(~}\StringTok{ }\NormalTok{violation)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{trafficstops %>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{wk_day =} \KeywordTok{wday}\NormalTok{(stop_date, }\DataTypeTok{label=}\OtherTok{TRUE}\NormalTok{)) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(wk_day, violation, driver_race) %>%}
\StringTok{  }\NormalTok{tally %>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{wk_day, }\DataTypeTok{y =} \NormalTok{n, }\DataTypeTok{color =} \NormalTok{driver_race, }\DataTypeTok{group =} \NormalTok{driver_race)) +}
...
\begin{Highlighting}[]
\NormalTok{trafficstops %>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{wk_day =} \KeywordTok{wday}\NormalTok{(stop_date, }\DataTypeTok{label=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{abbr=}\OtherTok{TRUE}\NormalTok{)) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(wk_day, violation, driver_race) %>%}
\StringTok{  }\NormalTok{tally %>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{wk_day, }\DataTypeTok{y =} \NormalTok{n, }\DataTypeTok{color =} \NormalTok{driver_race, }\DataTypeTok{group =} \NormalTok{driver_race)) +}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{() +}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stops_facet_plot <-}\StringTok{ }\NormalTok{trafficstops %>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{wk_day =} \KeywordTok{wday}\NormalTok{(stop_date, }\DataTypeTok{label=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{abbr=}\OtherTok{TRUE}\NormalTok{)) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(wk_day, violation, driver_race) %>%}
\StringTok{  }\NormalTok{tally %>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{wk_day, }\DataTypeTok{y =} \NormalTok{n, }\DataTypeTok{color =} \NormalTok{driver_race, }\DataTypeTok{group =} \NormalTok{driver_race)) +}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{'Observed violations per day of week'}\NormalTok{,}
         ...
         \DataTypeTok{y =} \StringTok{'Number of violations'}\NormalTok{) +}
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_plot <-}\StringTok{ }\NormalTok{stops_facet_plot +}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{'Observed violations per day of week'}\NormalTok{,}
         \DataTypeTok{x =} \StringTok{'Weekday of observation'}\NormalTok{,}
         \DataTypeTok{y =} \StringTok{'Number of violations'}\NormalTok{) +}
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{() +}\StringTok{ }
