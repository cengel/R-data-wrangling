...
> <h3>Challenge</h3>
>
>  Using pipes, subset the `stops` data to include stops in Tunica only and retain the columns `stop_date`, `driver_age`, and `violation`. Bonus: sort the table by driver age.
