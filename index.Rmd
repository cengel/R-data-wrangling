...
```{r, eval=FALSE, purl = FALSE}
download.file("https://github.com/cengel/R-data-wrangling/raw/master/data/MS_trafficstops_bw_age.csv",
              "data/MS_trafficstops_bw_age.csv")
```
- Download `MS_acs2015_bw.csv`:
```{r, eval=FALSE, purl = FALSE}
download.file("https://github.com/cengel/R-data-wrangling/raw/master/data/MS_acs2015_bw.csv",
